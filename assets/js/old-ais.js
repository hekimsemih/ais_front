...
import {AttributeType, makeProjectionTransform} from '../src/ol/webgl/Helper';
import {
...
const vertexShaderTemplate = fetchTemplate('/examples/shaders/aisvertex.vert');
const fragmentShaderTemplate = fetchTemplate('/examples/shaders/optimized_ais.frag');
const hitVertexShaderTemplate = fetchTemplate('/examples/shaders/hitais.vert');
const hitFragmentShaderTemplate = fetchTemplate('/examples/shaders/hitais.frag');
